class Unet_network:
    ...
    '''
    def __init__(self, input_shape, out_ch, loss='dice_loss', metrics=['dice_coef', 'dis_dice_coef'], style='basic', ite=2, depth=4, dim=32, weights='', init='he_normal',acti='elu',lr=1e-4):
